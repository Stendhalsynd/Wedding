  ...
  return (
    <div className="min-h-app-screen relative mx-auto flex w-full max-w-md flex-col bg-slate-50">
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-0 z-50 px-3 pb-safe-bottom">
        <nav className="pointer-events-auto mx-auto flex w-full max-w-md items-center justify-between rounded-t-3xl border-t border-white/50 bg-slate-50/80 px-6 py-4 backdrop-blur-md shadow-[0_-4px_16px_rgba(0,0,0,0.02)]">
          {navItems.map((item) => {
            const isActive =
            ...
            return (
              ...
              >
                <div className={`rounded-xl p-2 ${isActive ? 'clay-btn-active bg-rose-50' : ''}`}>
